...
public class App {
	...
	private static void cadastrarMotorista() {
		...
		try {
			...
			GerenciadorArquivos.salvarDados(motoristas, "motoristas.json");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	...
	private static void cadastrarCobrador() {
		...
		try {
			...
			GerenciadorArquivos.salvarDados(cobradores, "cobradores.json");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	...
	private static void cadastrarPassageiro() {
		...
		try {
			...
			GerenciadorArquivos.salvarDados(passageiros, "passageiros.json");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	...
	private static void cadastrarPontoDeParada() {
		...
		GerenciadorArquivos.salvarDados(pontos, "pontos.json");
	}
	...
	private static void cadastrarTrecho() {
		...
		try {
			...
			GerenciadorArquivos.salvarDados(trechos, "trechos.json");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		} catch (WrongInputException e) {
			System.out.println(e.getMessage());
	...
	private static void cadastrarTrajeto() {
		try {
			...
			GerenciadorArquivos.salvarDados(trajetos, "trajetos.json");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		} catch (WrongInputException e) {
			System.out.println(e.getMessage());
	...
	private static void cadastrarJornada() {
		...
		try {
			...
			GerenciadorArquivos.salvarDados(jornadas, "jornadas.json");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	}
