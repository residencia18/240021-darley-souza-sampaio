...
class PostagemTest {
	...
	public void testTextoCorreto() {
		...
		if (!violations.isEmpty())
			log.info("Teste para verificação de texto correto falhou: " + violations.toString());
	...
	public void testTextoVazio() {
		...
		if (violations.isEmpty())
			log.info("Teste para verificação de texto vazio falhou.");
	...
	public void testTextoNulo() {
		...
		if (violations.isEmpty())
			log.info("Teste para verificação de texto nulo falhou.");
