...
import com.dansoft.redesocial.controller.Form.ResetForm;
...
public class PasswordResetController {
	...
	public ResponseEntity<?> resetPassword(@RequestParam("token") String token, @RequestBody ResetForm novaSenha) {
		try {			
			return usuarioLoginService.updatePassword(token, novaSenha.senha());
		}catch (Exception e) {
