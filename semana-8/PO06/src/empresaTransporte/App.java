...
public class App {
	...
	private static void cadastrarVeiculo() {
		...
		try {
			...
			GerenciadorArquivos.SalvarArquivo(veiculos, "veiculos.dat");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	}
	...
	private static void cadastrarMotorista() {
		...
		try {
			...
			GerenciadorArquivos.SalvarArquivo(motoristas, "motoristas.dat");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	...
	private static void cadastrarCobrador() {
		...
		try {
			...
			GerenciadorArquivos.SalvarArquivo(cobradores, "cobradores.dat");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		...
		try {
			...
			if (cobradorEncontrado.isEmpty())
				...
				cobradorEncontrado.ifPresent(cobrador -> {
					...
					System.out.println("Cobrador removido com sucesso.\n");
					GerenciadorArquivos.SalvarArquivo(cobradores, "cobradores.dat");
				});
	...
	private static void cadastrarPassageiro() {
		...
		try {
			...
			GerenciadorArquivos.SalvarArquivo(passageiros, "passageiros.dat");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	...
	private static void cadastrarPontoDeParada() {
		...
		GerenciadorArquivos.SalvarArquivo(pontos, "pontos.dat");
	}
	...
	private static void cadastrarTrecho() {
		...
		try {
			...
			GerenciadorArquivos.SalvarArquivo(trechos, "trechos.dat");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		} catch (WrongInputException e) {
			System.out.println(e.getMessage());
		...
		try {
			...
			while (quantidade != 0) {
				...
				if (trechoEncontrado.isEmpty())
					...
					System.out.println("Trecho Adicionado.");
					quantidade--;
				}
			...
			GerenciadorArquivos.SalvarArquivo(trajetos, "trajetos.dat");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		} catch (WrongInputException e) {
			System.out.println(e.getMessage());
	...
	private static void cadastrarJornada() {
		...
		try {
			...
			GerenciadorArquivos.SalvarArquivo(jornadas, "jornadas.dat");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	}
